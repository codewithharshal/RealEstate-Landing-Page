        ...
        <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
          <div className="grid grid-cols-2 gap-6 md:gap-10 w-full 2xl pr-28">
            ...
            <div>
              ...
              <p className="">Projects Completeds</p>
            </div>
            <div>
          ...
          <p className="my-10 max-w-lg">
            ...
            maiores incidunt dignissimos exercitationem doloremque. Et corrupti
            autem quos corporis totam fugiat voluptatem vitae officia, ipsam
            cupiditate? Corporis, optio in.
          </p>
